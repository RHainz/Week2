// Arrays - Lista de Coisas - Indexadas
...
const arr3=["String", 10, false, [], {}, function algumaCoisa() {}];
console.log (arr3);
...
// push - coloca elemento por último.

arr4.push("Alexandre");
arr4.push("Zih");
arr4.push("Daniel");
arr4.push("Maxwell O CRUEL");
arr4.push("Roger KATANA");
console.log(arr4);
...
//splice - substitui;
//slice - copia pedaço da Array;

arr4.splice(1,2);
console.log(arr4);

const arr5= [ "Alexandre","Daniel","Roger","Caroline","Igor","Vini","Giu"];

for(let string of arr5){
    console.log(string);
    console.log(arr5.indexOf(string));
}

const filmes = [{nome: "BATIMA", duração:"2h e meia", preço:"CARO"},
                {nome: "MIRANHA", duração:"2h e meia", preço:"CARO"}
]
...
// console.log(movies[var][var - genre_ids][var]);
console.log(movies[0].genre_ids[0]);

// E se eu quiser colocar algo dentro da minha array de generos ?
